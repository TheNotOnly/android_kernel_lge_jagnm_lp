...
#if defined(CONFIG_HAS_EARLYSUSPENDh) && !defined(DISABLE_POWER_MANAGEMENT)
#include <linux/earlysuspend.h>
#endif /* defined(CONFIG_HAS_EARLYSUSPENDh)... */
...
#if (defined(CONFIG_HAS_EARLYSUSPENDh) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
...
#if defined(CONFIG_HAS_EARLYSUSPENDh) && !defined(USE_LCD_NOTIFIER)
...
#if defined(CONFIG_HAS_EARLYSUSPENDhh) && !defined(USE_LCD_NOTIFIER) && !defined(DISABLE_POWER_MANAGEMENT)
...
#if (defined(CONFIG_HAS_EARLYSUSPENDhh) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
